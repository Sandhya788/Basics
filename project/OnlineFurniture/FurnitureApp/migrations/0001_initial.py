# Generated by Django 3.0 on 2021-07-30 08:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uimg', models.ImageField(default='sofa.jpg', upload_to='Profilepics/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('roltype', models.IntegerField(choices=[(2, 'Manager'), (3, 'User')])),
                ('frpfe', models.ImageField(default='logo.jpg', upload_to='Rolereqpics/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pimage', models.ImageField(default='sofa.jpg', upload_to='Productimages/')),
                ('category', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='FurnitureApp.Category')),
            ],
        ),
        migrations.CreateModel(
            name='OnlineFurniture',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ...
                ('frimg', models.ImageField(default='sofa.jpg', upload_to='Furnitureimages/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fiimage', models.ImageField(default='sofa.jpg', upload_to='Itemimages/')),
                ('itavailability', models.CharField(choices=[('AV', 'Available'), ('NA', 'Not Available'), ('Sl', 'Select Availability')], default='Sl', max_length=20)),
                ('fsid', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='FurnitureApp.OnlineFurniture')),
            ],
        ),
    ]
